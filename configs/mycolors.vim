...
" Author: Gonzalo Uran <gonzalour@protonmail.com>
" Maintainer: Gonzalo Uran <gonzalour@protonmail.com>
" Notes: install under &runtimepath/../colors/ (~/.config/nvim/ belongs)
